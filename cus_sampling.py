...
def cus_sampler(X_train, y_train, number_of_clusters, percentage_to_choose_from_each_cluster):
    """
    ...
    minority_class = value[np.argmin(counts)]  #value = [0, 1]
