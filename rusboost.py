...
class RusBoostClassifier:
    ...
    def fit(self, X_train, y_train):
        ...
        for m in range(self.M):
            ...
            undersample_class = self.undersampler

            X_undersampled, y_undersampled = undersample_class.fit_sample(X_train, y_train) #number of minority instances become equal to the majority instances
            chosen_indices = undersample_class.sample_indices_
